...
class Hough_transform:
    def __init__(self, img, angle, step=5, threshold=135):
        ...
        :param angle: the input gradient matrix
        :param step: Hough step (stride)
        :param threshold: the threshold of choosing circles
        '''
        self.img = img
        self.angle = angle
    ...
    def Hough_transform_algorithm(self):
        '''
        build the 3D space according to x, y and radius
        vote along the gradient direction of the points on the edges
        :return: the vote matrix
        '''
    ...
    def Select_Circle(self):
        '''
        choose the appropriate circles from the vote matrix limited by the threshold
        and apply Non-maximum Suppression to it, which means taking average of nearby points here
        :return: None
        '''
    ...
    def Calculate(self):
        ...
        :return: result of circles, coordinates of centers and radius
        '''
